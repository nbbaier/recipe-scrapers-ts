...
import { NoSchemaFoundInWildMode, WebsiteNotImplementedError } from '../../src/exceptions';
...
describe('Factory Pattern', () => {
  ...
  describe('SchemaScraper', () => {
    it('should create a generic schema scraper', () => {
      ...
      const scraper = new SchemaScraper(html, 'https://unknown-site.com/recipe');
    ...
    it('should extract host name from URL', () => {
      ...
      const scraper = new SchemaScraper(html, 'https://example.com/path/to/recipe');
    ...
    it('should detect schema data presence', () => {
      ...
      const scraperWithSchema = new SchemaScraper(htmlWithSchema, 'https://example.com/recipe');
      const scraperWithoutSchema = new SchemaScraper(htmlWithoutSchema, 'https://example.com/recipe');
  ...
  describe('getSupportedUrls', () => {
    ...
    it('should return sorted list of registered domains', () => {
      ...
      // Check sorted order
      const testUrls = urls.filter((u) => u === 'apple.com' || u === 'banana.com' || u === 'zebra.com');
  ...
  describe('scrapeHtml - supported mode', () => {
    ...
    it('should pass bestImage option to scraper', () => {
      const html = '<html></html>';
      const scraper = scrapeHtml(html, 'https://test.com/recipe', { bestImage: true });
  ...
  describe('scrapeHtml - wild mode', () => {
    it('should use SchemaScraper for unsupported domain with Schema.org data', () => {
      ...
      const scraper = scrapeHtml(html, 'https://random-site.com/recipe', { supportedOnly: false });
    ...
    it('should prefer specific scraper over SchemaScraper even in wild mode', () => {
      ...
      const scraper = scrapeHtml(html, 'https://supported.com/recipe', { supportedOnly: false });
  ...
  describe('scrapeHtml - options handling', () => {
    ...
    it('should accept supportedOnly: false', () => {
      ...
      expect(() => {
        scrapeHtml(html, 'https://unsupported.com/recipe', { supportedOnly: false });
      }).not.toThrow();
    });
  ...
  describe('URL handling', () => {
    ...
    it('should extract hostname from full URL', () => {
      const html = '<html></html>';
      const scraper = scrapeHtml(html, 'https://example.com/path/to/recipe?id=123');
